        ...
        <div class="card pt-2">
            ...
            <table class="table datatable-scroll-y" width="100%" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$user->id}}</td>
                        <td><img class=" rounded-circle" src="{{url(asset('storage\user_photos\\' . $user->photo))}}"
                                height="60" alt=""></td>
                        <td>{{$user->name}}</td>
                        ...
                        <td>
                            <a href="{{url('users/'.$user->id)}}"><i class="icon-new-tab"></i>
                            </a>
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="" onclick="deleteUser({{$user->id}})" class="text-danger"><i
