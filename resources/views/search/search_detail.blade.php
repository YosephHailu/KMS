	...
	<div class="content mt-2">
		<div class="row">
			<div class="col-lg-8">
				...
				<div class="card">
					<div class="card-header header-elements-sm-inline">
						<span class="card-title font-weight-semibold text-muted">{{__('tags')}}</span>
					</div>

					<ul class="media-list row">
						@foreach (explode(',', $knowledge->keywords) as $word)

						<div class="breadcrumb-line  header-elements-md-inline">
							<div class="d-flex">
								<div class="breadcrumb">
									<a href="{{url('search/public/?q='.$word)}}" class="breadcrumb-item text-primary">/
										{{$word}}</a>
								</div>
			...
			<div class="col-lg-4">
				...
				<div class="pt-0 row">
					...
					<ul class="list-inline mb-0 col-md-6 col-lg-12">
